  ...
  return (
    ...
    >
      <div className="flex justify-between">
        <Link href="/">
          <div className="flex flex-col text-amber-950 items-center text-lg justify-center pl-20 pt-4">
            <svg
            ...
            <h2 className="">Backdoor</h2>
          </div>
        </Link>

        <div className="pr-20 pt-4 text-amber-950">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
